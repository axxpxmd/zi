                            ...
                            <div class="form-row form-inline">
                                <div class="col-md-12">
                                    <div class="form-group mt-1">
                                        <label for="n_unit_kerja" class="col-form-label s-12 col-md-4">Nama<span class="text-danger ml-1">*</span></label>
                                        <input type="text" name="n_unit_kerja" id="n_unit_kerja" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                                    </div>
                                    <div class="form-group m-0">
                                        <label for="alamat" class="col-form-label s-12 col-md-4">Alamat</label>
                                        <textarea name="alamat" id="alamat" class="form-control r-0 light s-12 col-md-8" autocomplete="off"></textarea>
                                    </div>
...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        columns: [
            ...
            {data: 'n_unit_kerja', name: 'n_unit_kerja'},
    ...
    function edit(id) {
        ...
        $.get("{{ route($route.'edit', ':id') }}".replace(':id', id), function(data){
            $('#id').val(data.id);
            $('#n_unit_kerja').val(data.n_unit_kerja).focus();
