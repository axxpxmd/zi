                            ...
                            <div class="form-row form-inline">
                                <div class="col-md-12">
                                    <div class="form-group mt-1">
                                        <label for="n_hasil_indikator" class="col-form-label s-12 col-md-4">Nama<span class="text-danger ml-1">*</span></label>
                                        <input type="text" name="n_hasil_indikator" id="n_hasil_indikator" placeholder="" class="form-control r-0 light s-12 col-md-8" autocomplete="off" required/>
                                    </div>
...
<script type="text/javascript">
    var table = $('#dataTable').dataTable({
        ...
        columns: [
            ...
            {data: 'n_hasil_indikator', name: 'n_hasil_indikator'},
    ...
    function edit(id) {
        ...
        $.get("{{ route($route.'edit', ':id') }}".replace(':id', id), function(data){
            $('#id').val(data.id);
            $('#n_hasil_indikator').val(data.n_hasil_indikator).focus();
